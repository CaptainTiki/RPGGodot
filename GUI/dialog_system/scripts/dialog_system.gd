...
@onready var content: RichTextLabel = $DialogUI/PanelContainer/DialogTextLabel
...
@onready var dialog_progress_label: Label = $DialogUI/DialogProgressIndicator/DialogProgressLabel
